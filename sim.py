...
print("Pr(E) using simulation = ",count_number_of_even/N)
print("Pr(F) using simulation = ",count_number_of_mul_of_3/N)
print("Pr(E intersection F) using simulation = ",count_number_of_even_and_mul_of_3/N)
print("Pr(E)*Pr(F) using simulation = ",(count_number_of_even/N)*(count_number_of_mul_of_3/N))
